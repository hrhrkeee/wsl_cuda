...
model_bbox.export(format="onnx", dynamic=True, simplify=True)
model_bbox = YOLO("yolov8n.onnx")

model_seg = YOLO("yolov8n-seg.pt")
model_seg.export(format="onnx", dynamic=True, simplify=True)
model_seg = YOLO("yolov8n-seg.onnx")
